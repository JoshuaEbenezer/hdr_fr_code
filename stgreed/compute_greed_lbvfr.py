...
dis_metadata_csv = pd.read_csv("/home/josh/hdr/hdr_chipqa/fall2021_yuv_rw_info.csv")
...
def greed_single_vid(i):
    ...
    dis_filename = os.path.join("/media/josh/seagate/hdr_videos/fall2021_hdr_upscaled_yuv",dis_basename)
    print(dis_filename)
...
#    dis_fps = orig_fps
    orig_filename = os.path.join("/media/josh/seagate/hdr_videos/fall2021_hdr_upscaled_yuv/",orig_basename)
