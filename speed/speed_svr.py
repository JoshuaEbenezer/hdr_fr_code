...
print(np.median([s[0] for s in srocc_list]),',',np.median([s[1] for s in srocc_list]),',',np.median([s[2] for s in srocc_list])\
        ,',',np.std([s[0] for s in srocc_list]),',',np.std([s[1] for s in srocc_list]),',',np.std([s[2] for s in srocc_list]))
